# Generated by Powerlevel10k configuration wizard on 2026-01-17 at 17:20 -03.
...
# sharp heads, blurred tails, 2 lines, disconnected, full frame, sparse, fluent,
...
() {
  ...
  # Función para detectar git worktrees
  function prompt_my_git_worktree() {
    ...
    if [[ -n "$git_dir" && -n "$common_dir" && "$git_dir" != "$common_dir" ]]; then
      # Estás en un worktree
      local worktree_name=$(basename "$(command git rev-parse --show-toplevel 2>/dev/null)")
      p10k segment -f 214 -i '🌳' -t "$worktree_name"
    fi
  }
  
  # Instant prompt para la función (necesario para que funcione)
  function instant_prompt_my_git_worktree() {
    prompt_my_git_worktree
  }
