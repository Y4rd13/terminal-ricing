...
# ═══════════════════════════════════════════════════════════════
# 🐚 CONFIGURACIÓN ZSH - ARCH LINUX / CACHYOS + WEZTERM
# ~/.zshrc
# ═══════════════════════════════════════════════════════════════
...
alias arch-clean="sudo pacman -Rns \$(pacman -Qtdq) 2>/dev/null || echo 'No orphan packages to remove'"
command -v paru &> /dev/null && alias aur-update="paru -Sua"
alias ports="ss -tuln"
...
# zsh-autosuggestions — Arch: pacman -S zsh-autosuggestions (/usr/share/zsh/plugins)
...
# zsh-syntax-highlighting — Arch: pacman -S zsh-syntax-highlighting (/usr/share/zsh/plugins)
